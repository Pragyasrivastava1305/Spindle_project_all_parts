function [th1,th2,rate] = Rates_static_ellipse_Final_Apr18(x,th,dth,s,a,b,ang,lA,lR,kn1,kn2,varargin)
%%%%% INPUT variables   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if lA >= b 
    error('DNA line is bigger than or equal to the cell width')
end
