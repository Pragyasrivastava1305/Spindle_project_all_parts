function [Omega,torq_dens1,torq_dens2,ang1,ang2] = Torque_static_pinned_Dev2(a,b,th,s,dth,rn,rs,sp_ang,lsp,Lm,x,sys_L,conc,varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% INPUT %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
