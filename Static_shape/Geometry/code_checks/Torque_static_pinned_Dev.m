function [Omega,torq_dens1,torq_dens2,ang1,ang2] = Torque_static_pinned_Dev(a,b,th,s,dth,rn,rs,sp_ang,lsp,Lm,x,sys_L,conc,varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% INPUT %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%% distance between centrosome and a point at periphery 
%%% centrosome 1
...
elseif (size(Ivec1,2) ==2)
    ...
    if (Exch1 == 0)  
        ...
        %%%% is discrete according to theta.
        ...
        %den1 = sqrt(r(arange1).^2 + lsp^2 -2*lsp*r(arange1));           
