function [Omega,torq_dens1,torq_dens2,ang1,ang2] = Torque_static_pinned_Final_Apr18(a,b,th,s,dth,rn,rs,sp_ang,lsp,Lm,x,L,conc,varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% INPUT %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     %%%% correct for the order of angles
    ...
    Omega = round(torq11+torq12+torq21+torq22,5);
