function f=Error_Cell_Jan18_single(dir,dx,num,sp_len,D,par1,varargin)
...
%%% l = inhibition range
%%% par1 = alpha
%%% par2 = parameters being optimised
...
%    
%   l=11; D=0.01; koffout=0.015; koffin=0.079; 
...
%%% Initial condition of simulation. To compare with old minimisation 
...
% f=sum(sum((exp_kym-sim_kym).^2))/size(cL_arr,1)/size(cL_arr,2);
