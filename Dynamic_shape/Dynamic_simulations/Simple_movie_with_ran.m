%%%%% code to make movies or plot snapshots. specify 
%%%%   time point tpnt for the latter. 
...
ws  = 0.5; 
plt_movie =0; 
load Dyn_sim_Phi_in=70_mu=0.007_dx1=0.002.mat
cl_lo = 0; cl_hi = 6;

%%%%% initialise movie if plt_movie ==1
if plt_movie ==1
mov =VideoWriter('mu0=6eminus4_phi_in=70.avi')
end
